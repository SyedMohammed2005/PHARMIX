...
import { Search, Filter, ChevronLeft, ChevronRight, PackageX, Calendar, Building2, Receipt, IndianRupee, RefreshCw } from "lucide-react";
    ...
    return (
      <div className="min-h-[400px] flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-3 text-sm text-gray-600">Loading purchase returns...</p>
        </div>
      </div>
    );
  }
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            <div className="bg-emerald-50 px-4 py-2 rounded-xl border border-emerald-100">
              <span className="text-xs font-medium text-emerald-700 uppercase tracking-wider">Total Returns</span>
              <p className="text-xl font-bold text-emerald-800">{pagination.total}</p>
            </div>
          </div>
        </div>
      </div>
                ...
                <tr>
                  ...
                  >
                    <div className="flex flex-col items-center">
                      ...
                      <p className="mt-3 text-sm font-medium text-gray-600">No purchase returns found</p>
                ...
                returns.map(
                  (purchaseReturn) => (
                    <tr
                      ...
                      className="group transition-all duration-150 hover:bg-emerald-50/30"
                    >
                      ...
                      <td className="px-4 py-4">
                        <span className="inline-flex items-center gap-1.5 rounded-full bg-emerald-50 px-2.5 py-0.5 text-xs font-medium text-emerald-700">
                          {purchaseReturn.items.length} item{purchaseReturn.items.length !== 1 ? 's' : ''}
                        </span>
                      </td>
